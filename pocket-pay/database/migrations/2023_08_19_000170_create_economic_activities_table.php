...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('economic_activities', function (Blueprint $table) {
            ...
            $table->string('name')->index('economic_activities_name')->unique('economic_activities_name');
            $table->string('code')->index('economic_activities_code')->unique('economic_activities_code');
